...
//		OrderItem i1 = new OrderItem(p1, 50);
		...
		System.out.println(Arrays.toString(list1.BubbleSortbyPrice(items)));
		System.out.println(Arrays.toString(list1.SelectionSortbyPrice(items)));
		System.out.println(Arrays.toString(list1.InsertionSortbyPrice(items)));
		System.out.println();
